    ...
    Grid.prototype = {
        ...
        _refreshHeight: function() {
            ...
            if(height !== "auto") {
                ...
                if( $('.jsgrid-grid-body').prop('scrollHeight') > $('.jsgrid-grid-body').prop('clientHeight')) {
					$('.jsgrid-grid-header').addClass('p_r20');
				}
				else {
					$('.jsgrid-grid-header').removeClass('p_r20');
				}
            }
        },
...
function formatDate(value) {
    return commonDate.dateTimeFormat2(String(value));
}
////////////////////////////////////////////////////////////////////////////////////////////////
